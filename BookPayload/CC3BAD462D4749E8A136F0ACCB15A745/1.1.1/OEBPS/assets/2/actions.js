 ...
 * 
 */
var obj1325_onTap_activeActionGroupIndex = -1;
var obj1325_onTap_runningActionsCount = 0;
var obj1325_onTap_loopCount = 0;
...
obj1325_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1325_onTap_activeActionGroupIndex = -1;
		$("#obj1325").trigger("obj1325_onTap_ended");
		
		return;
	}
	window.obj1325_onTap_activeActionGroupIndex = 0;
...
function hide_1327() {
	...
	window.obj1325_onTap_runningActionsCount = obj1325_onTap_runningActionsCount + 1;
	...
	if ($(element).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj1325_onTap_runningActionsCount = window.obj1325_onTap_runningActionsCount - 1;
if (window.obj1325_onTap_runningActionsCount == 0) {
	obj1325_onTap_actionGroup1();
}
		}, 1);
		return;
	};
...
obj1325_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj1325: Event Touch Down
 *
 */
 
$("#obj1325").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj1325_onTap_activeActionGroupIndex != -1) return;
var obj1325_onTap_runningActionsCount = 0;
var obj1325_onTap_loopCount = 0;
obj1325_onTap_actionGroup0();
});
